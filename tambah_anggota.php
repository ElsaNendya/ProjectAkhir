...
<center>
		...
		<form action="proses.php?aksi=tambah_anggota" method="post">

		<div class="form-group row justify-content-md-center">
		<label for="nama_anggota" class="col-sm-2 col-form-label">Nama Lengkap</label>
			<div class="col-6 col-sm-4">
			<div id="error_msg" align="center"></div>
			<input type="text" class="form-control" id="nama_anggota" value="" name="nama_anggota" autocomplete="off" required="">
			<div id="result"></div>
		...
		<label for="nis_anggota" class="col-sm-2 col-form-label">NIS</label>
			<div class="col-6 col-sm-4">
			<div id="error_msg" align="center"></div>
			<input type="text" class="form-control" id="nis_anggota" value="" name="nis_anggota" autocomplete="off" required>
		...
		<div class="form-group row justify-content-md-center">
				...
				<div class="col-6 col-sm-4">
				<select name="jurusan_anggota" class="custom-select custom-select-sm" id="">
					...
					<option value="BC">Brodcasting</option>
				</select>
		</div>
		</div>
