...
<center>
		...
		<form action="proses.php?aksi=tambah_kembali" method="post">
		
		<div class="form-group row justify-content-md-center">
		<label for="id_pinjam" class="col-sm-2 col-form-label">ID Pinjam</label>
			<div class="col-6 col-sm-4">
			<div id="error_msg" align="center"></div>
			<input type="text" class="form-control" id="id_pinjam" value="" name="id_pinjam" autocomplete="off" required="">
			<div id="result"></div>
			<div class="invalid-feedback">
				Silakan Masukkan ID Pinjam
			</div>
			<span></span>
			</div>
		</div>
